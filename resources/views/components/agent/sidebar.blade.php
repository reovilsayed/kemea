        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="home-collapse" style="">
                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <li><a href="{{route('agent.dashboard.properties.create')}}" class="nav-link ms-4  text-dark bg-white">Add Propertices</a></li>
                    <li><a href="{{route('agent.dashboard.properties.index')}}" class="nav-link ms-4  text-dark bg-white">Listed Propertices</a></li>
