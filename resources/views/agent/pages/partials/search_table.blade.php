                ...
                <td class="text-center">
                    <div class="d-flex justify-content-center align-items-center">
                        ...
                        <button class="btn btn-custom-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"
                            ...
                            data-property_type="{{ $search->property_type }}"
                            data-bedrooms="{{ $search->bedrooms }}"
                            data-budget="{{ $search->budget }}"
                            data-date_of_entry="{{ $search->date_of_entry }}"
                            data-city="{{ $search->city }}"
                            data-comment="{{ $search->comment }}">
