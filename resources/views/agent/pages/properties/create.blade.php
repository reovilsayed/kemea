            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-8 col-12 px-4">
                        <div class=" d-md-flex align-items-center">
                            <label for="Surface" class="form-label text-bolder w-md-40" style="color: #191C1F">Surface
                                of
                                the
                                Land sqm:</label>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-2 col-12 px-4 mt-3 mt-md-0">
                    ...
                    <div class="col-md-3 col-12 px-4 mt-3 mt-md-0">
                        <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="row mb-4">
                    <div class="col-md-4 col-12 px-4">
                        <div class=" d-md-flex align-items-center">
                            <label for="Arnona" class="form-label text-bolder w-md-25" style="color: #191C1F">Arnona 2
                                months:</label>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-5">
                        <div class="">
                            <label for="agents" class="form-label text-bold" style="color: #191C1F">Share with other
                                agents
                                (% Shared)</label>
                ...
                <div class="row mb-4">
                    <div class="col-md-2 ms-4 p-0">
                        <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                            <input type="checkbox" class="btn-check" id="btncheck1" autocomplete="off">
                            <label class="btn btn-primary px-5 py-2" for="btncheck1">New Ad</label>
                        </div>
                    </div>
                    <div class="col-md-2 p-0">
                        <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                            <input type="checkbox" class="btn-check" id="btncheck2" autocomplete="off">
                            <label class="btn btn-primary px-5 py-2" for="btncheck2">Top Ad</label>
                        </div>
                    </div>
                    <div class="col-md-2 p-0">
                        <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                            <input type="checkbox" class="btn-check" id="btncheck3" autocomplete="off">
                            <label class="btn btn-primary px-5 py-2" for="btncheck3">Preferred Ad</label>
                        </div>
                    </div>
                    <div class="col-md-2 p-0">
                        <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                            <input type="checkbox" class="btn-check" id="btncheck4" autocomplete="off">
                            <label class="btn btn-primary px-5 py-2" for="btncheck4">Large Visibility</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                            <input type="checkbox" class="btn-check" id="btncheck5" autocomplete="off">
                            <label class="btn btn-primary px-5 py-2" for="btncheck5"> Video First Ad</label>
                        </div>
                    </div>
                </div>
                </div>
