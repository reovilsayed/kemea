<x-agent.app>
  ...
  <form action="{{ route('agent.dashboard.officeProfile_store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="col-md-6 col-12">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="name" id="name" placeholder="Office Name">
            </div>
          </div>
          <div class="col-md-6 col-12">
            <div class="mb-3">
              <label for="email" class="form-lable"> Office Email</label>
              <input type="email" class="form-control" name="email" id="email" placeholder="Office Email">
            </div>
          </div>
          ...
          <div class="col-md-6 col-12">
            <div class="mb-3">
              ...
              <input type="tel" class="form-control" name="phone" id="phone" placeholder="Office phone">
            </div>
          </div>
          ...
          <div class="col-md-6 col-12">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="address" id="Address" placeholder="Office Address">
            </div>
          </div>
          <div class="col-md-12 col-12">
            <div class="mb-3">
              ...
              <textarea class="form-control" name="details" id="details" rows="4"
                placeholder="Overview/Details"></textarea>
            </div>
          </div>
          ...
          <div class="col-md-12 col-12">
            ...
            <div class="mb-4">
              ...
              <label for="logo" class="upload-container w-100">
                ...
                <p class="fs-5 text-dark fw-bolder">Drop your images here, or <span class="text-primary">click to
                    browse</span></p>
    ...
    <div class="d-flex justify-content-end align-items-center gap-3 my-4 mx-4">
      <button class="btn btn-primary px-4 py-2" style="font-size: 14px; color: #0666EB; background-color: #0666eb47;">Copy Office Page Link</button>
      <button class="btn btn-primary px-4 py-2" style="font-size: 14px; color: #0666EB; background-color: #0666eb47;">Preview Office Profile</button>
