<x-agent.app>
    ...
    <form action="" method="">
        <div class="card m-4 my-0">
            <div class="card-body">
                <h4 class="text-bold text-primary" style="font-size: 18px; color: #191C1F;">Shared Searches</h4>
                <p class=" text-dark">Lorem ipsum dolor sit amet, Veritatis omnis sit eius unde sunt libero ad
                ...
                <div class="row mb-4">
                    <div class="col-md-12 col-12">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4">
                                <label for="Property_for" class="form-label text-bold" style="color: #191C1F">Date of
                                    Entry</label>
                                <select class="form-select custom-select" aria-label="Default select example"
                                    id="Property_for">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <label for="city" class="form-label text-bold" style="color: #191C1F">Commend</label>
                            ...
                            <div class="col-4">
                                <div class="row mt-4 justify-content-end">
                                    ...
                                    <div class="col-5 pt-3  d-flex justify-content-center">
                                        <button type="button" class="btn btn-primary w-90 m-0">Add</button>
                                    </div>
                ...
                <div class="col-md-6 mb-4">
                    <label for="Property_for" class="form-label text-bold" style="color: #191C1F">Search Type</label>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center align-items-center">
                                        <a href="" class="btn btn-custom-info me-1"> <i class="material-symbols-rounded ">
                                                colorize</i></a>
                                        <a href="" class="btn btn-custom-danger me-1"> <i
                                                class="fa-solid fa-trash-can"></i></a>
                                        <a href="" class="btn btn-custom-primary"> <i class="material-symbols-rounded ">
                                                arrow_forward</i></a>
                                    </div>
                                </td>
